...
URL = 'https://www.thechristmastreecompany.com.au/product/the-belgian-berry-7ft-green-1604-tips/'
...
# Extract price
productpriceextract = soup.find(attrs={'class': 'price'})
#print(productpriceextract)
productprice = productpriceextract.find("bdi").contents[1]
